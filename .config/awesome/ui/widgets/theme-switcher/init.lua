...
night:connect_signal("button::press", function()
	awful.spawn.with_shell("source " .. gears.filesystem.get_configuration_dir() .. "theme/themes night")
	awesome.restart()
end)
...
day:connect_signal("button::press", function()
	awful.spawn.with_shell("source " .. gears.filesystem.get_configuration_dir() .. "theme/themes day")
	awesome.restart()
end)
