...
complete -c cast -n "__fish_cast_needs_command" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand max-int" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand --max-int" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand --max-int" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c cast -n "__fish_cast_using_subcommand maxi" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand min-int" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand --min-int" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand --min-int" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c cast -n "__fish_cast_using_subcommand mini" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand max-uint" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand --max-uint" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand --max-uint" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c cast -n "__fish_cast_using_subcommand maxu" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand address-zero" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand --address-zero" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand --address-zero" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c cast -n "__fish_cast_using_subcommand az" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand hash-zero" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand --hash-zero" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand --hash-zero" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c cast -n "__fish_cast_using_subcommand hz" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand from-utf8" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand --from-ascii" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand from-ascii" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand from-ascii" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c cast -n "__fish_cast_using_subcommand fu" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand fa" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand concat-hex" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand --concat-hex" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand --concat-hex" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c cast -n "__fish_cast_using_subcommand ch" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand from-bin" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand --from-bin" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand --from-bin" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c cast -n "__fish_cast_using_subcommand from-binx" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand fb" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand to-hexdata" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand --to-hexdata" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand --to-hexdata" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c cast -n "__fish_cast_using_subcommand thd" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand 2hd" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand to-check-sum-address" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand --to-checksum-address" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand --to-checksum" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand to-checksum" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand to-checksum" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c cast -n "__fish_cast_using_subcommand ta" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand 2a" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand to-ascii" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand --to-ascii" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand --to-ascii" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c cast -n "__fish_cast_using_subcommand tas" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand 2as" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand to-utf8" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand --to-utf8" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand --to-utf8" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c cast -n "__fish_cast_using_subcommand tu8" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand 2u8" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand from-fixed-point" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand --from-fix" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand ff" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand to-bytes32" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand --to-bytes32" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand --to-bytes32" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c cast -n "__fish_cast_using_subcommand tb" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand 2b" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand to-fixed-point" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand --to-fix" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand tf" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand 2f" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand to-uint256" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand --to-uint256" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand --to-uint256" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c cast -n "__fish_cast_using_subcommand tu" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand 2u" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand to-int256" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand --to-int256" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand --to-int256" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c cast -n "__fish_cast_using_subcommand ti" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand 2i" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand shl" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand shr" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand to-unit" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand --to-unit" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand --to-unit" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c cast -n "__fish_cast_using_subcommand tun" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand 2un" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand parse-units" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand --parse-units" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand --parse-units" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c cast -n "__fish_cast_using_subcommand pun" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand format-units" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand --format-units" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand --format-units" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c cast -n "__fish_cast_using_subcommand fun" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand to-wei" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand --to-wei" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand --to-wei" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c cast -n "__fish_cast_using_subcommand tw" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand 2w" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand from-wei" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand --from-wei" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand --from-wei" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c cast -n "__fish_cast_using_subcommand fw" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand to-rlp" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand --to-rlp" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand --to-rlp" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c cast -n "__fish_cast_using_subcommand from-rlp" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand to-hex" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand th" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand 2h" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand to-dec" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand td" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand 2d" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand to-base" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand --to-radix" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand tr" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand 2r" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand access-list" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand ac" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand acl" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand logs" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand l" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand block" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand bl" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand block-number" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand bn" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand call; and not __fish_seen_subcommand_from --create help" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand call; and __fish_seen_subcommand_from --create" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand c; and not __fish_seen_subcommand_from --create help" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand c; and __fish_seen_subcommand_from --create" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand calldata" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand cd" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand chain" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand chain-id" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand ci" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand cid" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand client" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand cl" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand compute-address" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand ca" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand disassemble" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand da" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand mktx; and not __fish_seen_subcommand_from --create help" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand mktx; and __fish_seen_subcommand_from --create" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand m; and not __fish_seen_subcommand_from --create help" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand m; and __fish_seen_subcommand_from --create" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand namehash" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand na" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand nh" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand tx" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand t" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand receipt" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand re" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand send; and not __fish_seen_subcommand_from --create help" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand send; and __fish_seen_subcommand_from --create" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand s; and not __fish_seen_subcommand_from --create help" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand s; and __fish_seen_subcommand_from --create" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand publish" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand p" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand estimate; and not __fish_seen_subcommand_from --create help" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand estimate; and __fish_seen_subcommand_from --create" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand e; and not __fish_seen_subcommand_from --create help" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand e; and __fish_seen_subcommand_from --create" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand decode-calldata" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand calldata-decode" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand --calldata-decode" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand --calldata-decode" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c cast -n "__fish_cast_using_subcommand cdd" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand decode-string" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand string-decode" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand --string-decode" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand --string-decode" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c cast -n "__fish_cast_using_subcommand sd" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand decode-event" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand event-decode" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand ed" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand decode-error" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand error-decode" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand erd" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand decode-abi" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand abi-decode" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand --abi-decode" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand --abi-decode" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c cast -n "__fish_cast_using_subcommand ad" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand abi-encode" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand ae" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand index" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand in" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand index-erc7201" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand index7201" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand in7201" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand implementation" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand impl" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand admin" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand adm" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand 4byte" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand 4" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand 4b" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand 4byte-decode" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand 4d" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand 4bd" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand 4byte-event" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand 4e" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand 4be" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand topic0-event" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand t0e" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand upload-signature" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand ups" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand pretty-calldata" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand pc" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand age" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand a" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand balance" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand b" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand base-fee" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand ba" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand fee" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand basefee" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand code" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand co" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand codesize" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand cs" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand gas-price" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand g" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand sig-event" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand se" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand keccak" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand k" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand keccak256" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand hash-message" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand --hash-message" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand --hash-message" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c cast -n "__fish_cast_using_subcommand hm" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand resolve-name" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand rn" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand lookup-address" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand la" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand storage" -l optimize -d 'Activate the Solidity optimizer' -r -f -a "{true\t'',false\t''}"
...
complete -c cast -n "__fish_cast_using_subcommand storage" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand st" -l optimize -d 'Activate the Solidity optimizer' -r -f -a "{true\t'',false\t''}"
...
complete -c cast -n "__fish_cast_using_subcommand st" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand proof" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand pr" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand nonce" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand n" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand codehash" -s r -l rpc-url -d 'The RPC endpoint' -r
...
complete -c cast -n "__fish_cast_using_subcommand codehash" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand storage-root" -s r -l rpc-url -d 'The RPC endpoint' -r
...
complete -c cast -n "__fish_cast_using_subcommand storage-root" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand sr" -s r -l rpc-url -d 'The RPC endpoint' -r
...
complete -c cast -n "__fish_cast_using_subcommand sr" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand etherscan-source" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
complete -c cast -n "__fish_cast_using_subcommand etherscan-source" -s j -l threads -l jobs -d 'Number of threads to use. Specifying 0 defaults to the number of logical cores' -r
complete -c cast -n "__fish_cast_using_subcommand etherscan-source" -s f -l flatten -d 'Whether to flatten the source code'
complete -c cast -n "__fish_cast_using_subcommand etherscan-source" -s v -l verbosity -d 'Verbosity level of the log messages.'
complete -c cast -n "__fish_cast_using_subcommand etherscan-source" -s q -l quiet -d 'Do not print log messages'
complete -c cast -n "__fish_cast_using_subcommand etherscan-source" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand etherscan-source" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c cast -n "__fish_cast_using_subcommand et" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand src" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand wallet; and not __fish_seen_subcommand_from new n new-mnemonic nm vanity va address a addr sign s sign-auth sa verify v import i list ls private-key pk decrypt-keystore dk help" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand wallet; and __fish_seen_subcommand_from new" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand wallet; and __fish_seen_subcommand_from n" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand wallet; and __fish_seen_subcommand_from new-mnemonic" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand wallet; and __fish_seen_subcommand_from nm" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand wallet; and __fish_seen_subcommand_from vanity" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand wallet; and __fish_seen_subcommand_from va" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand wallet; and __fish_seen_subcommand_from address" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand wallet; and __fish_seen_subcommand_from a" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand wallet; and __fish_seen_subcommand_from addr" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand wallet; and __fish_seen_subcommand_from sign" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand wallet; and __fish_seen_subcommand_from s" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand wallet; and __fish_seen_subcommand_from sign-auth" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand wallet; and __fish_seen_subcommand_from sa" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand wallet; and __fish_seen_subcommand_from verify" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand wallet; and __fish_seen_subcommand_from v" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand wallet; and __fish_seen_subcommand_from import" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand wallet; and __fish_seen_subcommand_from i" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand wallet; and __fish_seen_subcommand_from list" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand wallet; and __fish_seen_subcommand_from ls" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand wallet; and __fish_seen_subcommand_from private-key" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand wallet; and __fish_seen_subcommand_from pk" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand wallet; and __fish_seen_subcommand_from decrypt-keystore" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand wallet; and __fish_seen_subcommand_from dk" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand w; and __fish_seen_subcommand_from new" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand w; and __fish_seen_subcommand_from n" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand w; and __fish_seen_subcommand_from new-mnemonic" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand w; and __fish_seen_subcommand_from nm" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand w; and __fish_seen_subcommand_from vanity" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand w; and __fish_seen_subcommand_from va" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand w; and __fish_seen_subcommand_from address" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand w; and __fish_seen_subcommand_from a" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand w; and __fish_seen_subcommand_from addr" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand w; and __fish_seen_subcommand_from sign" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand w; and __fish_seen_subcommand_from s" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand w; and __fish_seen_subcommand_from sign-auth" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand w; and __fish_seen_subcommand_from sa" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand w; and __fish_seen_subcommand_from verify" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand w; and __fish_seen_subcommand_from v" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand w; and __fish_seen_subcommand_from import" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand w; and __fish_seen_subcommand_from i" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand w; and __fish_seen_subcommand_from list" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand w; and __fish_seen_subcommand_from ls" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand w; and __fish_seen_subcommand_from private-key" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand w; and __fish_seen_subcommand_from pk" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand w; and __fish_seen_subcommand_from decrypt-keystore" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand w; and __fish_seen_subcommand_from dk" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand creation-code" -s r -l rpc-url -d 'The RPC endpoint' -r
...
complete -c cast -n "__fish_cast_using_subcommand creation-code" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand cc" -s r -l rpc-url -d 'The RPC endpoint' -r
...
complete -c cast -n "__fish_cast_using_subcommand cc" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand artifact" -s r -l rpc-url -d 'The RPC endpoint' -r
...
complete -c cast -n "__fish_cast_using_subcommand artifact" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand ar" -s r -l rpc-url -d 'The RPC endpoint' -r
...
complete -c cast -n "__fish_cast_using_subcommand ar" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand constructor-args" -s r -l rpc-url -d 'The RPC endpoint' -r
...
complete -c cast -n "__fish_cast_using_subcommand constructor-args" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand cra" -s r -l rpc-url -d 'The RPC endpoint' -r
...
complete -c cast -n "__fish_cast_using_subcommand cra" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand interface" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand i" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand bind" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand bi" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand sig" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand si" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand create2" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand c2" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand find-block" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand f" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand completions" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand com" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand generate-fig-spec" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand fig" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand run" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand r" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand rpc" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand rp" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand format-bytes32-string" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand --format-bytes32-string" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand --format-bytes32-string" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c cast -n "__fish_cast_using_subcommand parse-bytes32-string" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand --parse-bytes32-string" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand --parse-bytes32-string" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c cast -n "__fish_cast_using_subcommand parse-bytes32-address" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand --parse-bytes32-address" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand --parse-bytes32-address" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c cast -n "__fish_cast_using_subcommand decode-transaction" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand dt" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand decode-tx" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand selectors" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand sel" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c cast -n "__fish_cast_using_subcommand decode-eof" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
