...
complete -c forge -n "__fish_forge_needs_command" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand test" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand test" -l debug -d 'Run a single test in the debugger' -r
complete -c forge -n "__fish_forge_using_subcommand test" -l decode-internal -d 'Identify internal functions in traces' -r
...
complete -c forge -n "__fish_forge_using_subcommand test" -l optimize -d 'Activate the Solidity optimizer' -r -f -a "{true\t'',false\t''}"
...
complete -c forge -n "__fish_forge_using_subcommand t" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand t" -l debug -d 'Run a single test in the debugger' -r
complete -c forge -n "__fish_forge_using_subcommand t" -l decode-internal -d 'Identify internal functions in traces' -r
...
complete -c forge -n "__fish_forge_using_subcommand t" -l optimize -d 'Activate the Solidity optimizer' -r -f -a "{true\t'',false\t''}"
...
complete -c forge -n "__fish_forge_using_subcommand script" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand script" -l optimize -d 'Activate the Solidity optimizer' -r -f -a "{true\t'',false\t''}"
...
complete -c forge -n "__fish_forge_using_subcommand script" -l verifier -d 'The contract verification provider to use' -r -f -a "{etherscan\t'',sourcify\t'',blockscout\t'',oklink\t'',custom\t'Custom verification provider, requires compatibility with the Etherscan API'}"
...
complete -c forge -n "__fish_forge_using_subcommand coverage" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand coverage" -l debug -d 'Run a single test in the debugger' -r
complete -c forge -n "__fish_forge_using_subcommand coverage" -l decode-internal -d 'Identify internal functions in traces' -r
...
complete -c forge -n "__fish_forge_using_subcommand coverage" -l optimize -d 'Activate the Solidity optimizer' -r -f -a "{true\t'',false\t''}"
...
complete -c forge -n "__fish_forge_using_subcommand bind" -l optimize -d 'Activate the Solidity optimizer' -r -f -a "{true\t'',false\t''}"
...
complete -c forge -n "__fish_forge_using_subcommand bind" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand build" -l optimize -d 'Activate the Solidity optimizer' -r -f -a "{true\t'',false\t''}"
...
complete -c forge -n "__fish_forge_using_subcommand build" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand b" -l optimize -d 'Activate the Solidity optimizer' -r -f -a "{true\t'',false\t''}"
...
complete -c forge -n "__fish_forge_using_subcommand b" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand compile" -l optimize -d 'Activate the Solidity optimizer' -r -f -a "{true\t'',false\t''}"
...
complete -c forge -n "__fish_forge_using_subcommand compile" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand clone" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand debug" -l dump -d 'File path to dump execution details as JSON' -r -F
...
complete -c forge -n "__fish_forge_using_subcommand debug" -l optimize -d 'Activate the Solidity optimizer' -r -f -a "{true\t'',false\t''}"
complete -c forge -n "__fish_forge_using_subcommand debug" -l optimizer-runs -d 'The number of runs specifies roughly how often each opcode of the deployed code will be executed across the life-time of the contract. This means it is a trade-off parameter between code size (deploy cost) and code execution cost (cost after deployment). An `optimizer_runs` parameter of `1` will produce short but expensive code. In contrast, a larger `optimizer_runs` parameter will produce longer but more gas efficient code' -r
...
complete -c forge -n "__fish_forge_using_subcommand debug" -l create2-deployer -d 'The CREATE2 deployer address to use, this will override the one in the config' -r
...
complete -c forge -n "__fish_forge_using_subcommand debug" -l block-gas-limit -l gas-limit -d 'The block gas limit' -r
...
complete -c forge -n "__fish_forge_using_subcommand debug" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
complete -c forge -n "__fish_forge_using_subcommand debug" -s j -l threads -l jobs -d 'Number of threads to use. Specifying 0 defaults to the number of logical cores' -r
...
complete -c forge -n "__fish_forge_using_subcommand debug" -l eof -d 'Use EOF-enabled solc binary. Enables via-ir and sets EVM version to Prague. Requires Docker to be installed'
...
complete -c forge -n "__fish_forge_using_subcommand debug" -l odyssey -d 'Whether to enable Odyssey features'
complete -c forge -n "__fish_forge_using_subcommand debug" -s v -l verbosity -d 'Verbosity level of the log messages.'
complete -c forge -n "__fish_forge_using_subcommand debug" -s q -l quiet -d 'Do not print log messages'
complete -c forge -n "__fish_forge_using_subcommand debug" -l json -d 'Format log messages as JSON'
...
complete -c forge -n "__fish_forge_using_subcommand d" -l dump -d 'File path to dump execution details as JSON' -r -F
...
complete -c forge -n "__fish_forge_using_subcommand d" -l optimize -d 'Activate the Solidity optimizer' -r -f -a "{true\t'',false\t''}"
complete -c forge -n "__fish_forge_using_subcommand d" -l optimizer-runs -d 'The number of runs specifies roughly how often each opcode of the deployed code will be executed across the life-time of the contract. This means it is a trade-off parameter between code size (deploy cost) and code execution cost (cost after deployment). An `optimizer_runs` parameter of `1` will produce short but expensive code. In contrast, a larger `optimizer_runs` parameter will produce longer but more gas efficient code' -r
...
complete -c forge -n "__fish_forge_using_subcommand d" -l create2-deployer -d 'The CREATE2 deployer address to use, this will override the one in the config' -r
...
complete -c forge -n "__fish_forge_using_subcommand d" -l block-gas-limit -l gas-limit -d 'The block gas limit' -r
...
complete -c forge -n "__fish_forge_using_subcommand d" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
complete -c forge -n "__fish_forge_using_subcommand d" -s j -l threads -l jobs -d 'Number of threads to use. Specifying 0 defaults to the number of logical cores' -r
...
complete -c forge -n "__fish_forge_using_subcommand d" -l eof -d 'Use EOF-enabled solc binary. Enables via-ir and sets EVM version to Prague. Requires Docker to be installed'
...
complete -c forge -n "__fish_forge_using_subcommand d" -l odyssey -d 'Whether to enable Odyssey features'
complete -c forge -n "__fish_forge_using_subcommand d" -s v -l verbosity -d 'Verbosity level of the log messages.'
complete -c forge -n "__fish_forge_using_subcommand d" -s q -l quiet -d 'Do not print log messages'
complete -c forge -n "__fish_forge_using_subcommand d" -l json -d 'Format log messages as JSON'
...
complete -c forge -n "__fish_forge_using_subcommand update" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand u" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand install" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand i" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand remove" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand rm" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand remappings" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand re" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand verify-contract" -l verifier -d 'The contract verification provider to use' -r -f -a "{etherscan\t'',sourcify\t'',blockscout\t'',oklink\t'',custom\t'Custom verification provider, requires compatibility with the Etherscan API'}"
...
complete -c forge -n "__fish_forge_using_subcommand verify-contract" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand v" -l verifier -d 'The contract verification provider to use' -r -f -a "{etherscan\t'',sourcify\t'',blockscout\t'',oklink\t'',custom\t'Custom verification provider, requires compatibility with the Etherscan API'}"
...
complete -c forge -n "__fish_forge_using_subcommand v" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand verify-check" -l verifier -d 'The contract verification provider to use' -r -f -a "{etherscan\t'',sourcify\t'',blockscout\t'',oklink\t'',custom\t'Custom verification provider, requires compatibility with the Etherscan API'}"
...
complete -c forge -n "__fish_forge_using_subcommand verify-check" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand vc" -l verifier -d 'The contract verification provider to use' -r -f -a "{etherscan\t'',sourcify\t'',blockscout\t'',oklink\t'',custom\t'Custom verification provider, requires compatibility with the Etherscan API'}"
...
complete -c forge -n "__fish_forge_using_subcommand vc" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand verify-bytecode" -l verifier -d 'The contract verification provider to use' -r -f -a "{etherscan\t'',sourcify\t'',blockscout\t'',oklink\t'',custom\t'Custom verification provider, requires compatibility with the Etherscan API'}"
...
complete -c forge -n "__fish_forge_using_subcommand verify-bytecode" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand vb" -l verifier -d 'The contract verification provider to use' -r -f -a "{etherscan\t'',sourcify\t'',blockscout\t'',oklink\t'',custom\t'Custom verification provider, requires compatibility with the Etherscan API'}"
...
complete -c forge -n "__fish_forge_using_subcommand vb" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand create" -l optimize -d 'Activate the Solidity optimizer' -r -f -a "{true\t'',false\t''}"
...
complete -c forge -n "__fish_forge_using_subcommand create" -l verifier -d 'The contract verification provider to use' -r -f -a "{etherscan\t'',sourcify\t'',blockscout\t'',oklink\t'',custom\t'Custom verification provider, requires compatibility with the Etherscan API'}"
...
complete -c forge -n "__fish_forge_using_subcommand create" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand c" -l optimize -d 'Activate the Solidity optimizer' -r -f -a "{true\t'',false\t''}"
...
complete -c forge -n "__fish_forge_using_subcommand c" -l verifier -d 'The contract verification provider to use' -r -f -a "{etherscan\t'',sourcify\t'',blockscout\t'',oklink\t'',custom\t'Custom verification provider, requires compatibility with the Etherscan API'}"
...
complete -c forge -n "__fish_forge_using_subcommand c" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand init" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand completions" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand com" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand generate-fig-spec" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand fig" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand clean" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand cl" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand cache; and not __fish_seen_subcommand_from clean ls help" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand cache; and __fish_seen_subcommand_from clean" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand cache; and __fish_seen_subcommand_from ls" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand snapshot" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand snapshot" -l debug -d 'Run a single test in the debugger' -r
complete -c forge -n "__fish_forge_using_subcommand snapshot" -l decode-internal -d 'Identify internal functions in traces' -r
...
complete -c forge -n "__fish_forge_using_subcommand snapshot" -l optimize -d 'Activate the Solidity optimizer' -r -f -a "{true\t'',false\t''}"
...
complete -c forge -n "__fish_forge_using_subcommand s" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand s" -l debug -d 'Run a single test in the debugger' -r
complete -c forge -n "__fish_forge_using_subcommand s" -l decode-internal -d 'Identify internal functions in traces' -r
...
complete -c forge -n "__fish_forge_using_subcommand s" -l optimize -d 'Activate the Solidity optimizer' -r -f -a "{true\t'',false\t''}"
...
complete -c forge -n "__fish_forge_using_subcommand config" -l optimize -d 'Activate the Solidity optimizer' -r -f -a "{true\t'',false\t''}"
...
complete -c forge -n "__fish_forge_using_subcommand config" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand co" -l optimize -d 'Activate the Solidity optimizer' -r -f -a "{true\t'',false\t''}"
...
complete -c forge -n "__fish_forge_using_subcommand co" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand flatten" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand f" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand fmt" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand inspect" -l optimize -d 'Activate the Solidity optimizer' -r -f -a "{true\t'',false\t''}"
...
complete -c forge -n "__fish_forge_using_subcommand inspect" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand in" -l optimize -d 'Activate the Solidity optimizer' -r -f -a "{true\t'',false\t''}"
...
complete -c forge -n "__fish_forge_using_subcommand in" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand tree" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand tr" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand geiger" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand doc" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand selectors; and not __fish_seen_subcommand_from collision co upload up list ls find f cache c help" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand selectors; and __fish_seen_subcommand_from collision" -l optimize -d 'Activate the Solidity optimizer' -r -f -a "{true\t'',false\t''}"
...
complete -c forge -n "__fish_forge_using_subcommand selectors; and __fish_seen_subcommand_from collision" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand selectors; and __fish_seen_subcommand_from co" -l optimize -d 'Activate the Solidity optimizer' -r -f -a "{true\t'',false\t''}"
...
complete -c forge -n "__fish_forge_using_subcommand selectors; and __fish_seen_subcommand_from co" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand selectors; and __fish_seen_subcommand_from upload" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand selectors; and __fish_seen_subcommand_from up" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand selectors; and __fish_seen_subcommand_from list" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand selectors; and __fish_seen_subcommand_from ls" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand selectors; and __fish_seen_subcommand_from find" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand selectors; and __fish_seen_subcommand_from f" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand selectors; and __fish_seen_subcommand_from cache" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand selectors; and __fish_seen_subcommand_from c" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand se; and not __fish_seen_subcommand_from collision co upload up list ls find f cache c help" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand se; and __fish_seen_subcommand_from collision" -l optimize -d 'Activate the Solidity optimizer' -r -f -a "{true\t'',false\t''}"
...
complete -c forge -n "__fish_forge_using_subcommand se; and __fish_seen_subcommand_from collision" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand se; and __fish_seen_subcommand_from co" -l optimize -d 'Activate the Solidity optimizer' -r -f -a "{true\t'',false\t''}"
complete -c forge -n "__fish_forge_using_subcommand se; and __fish_seen_subcommand_from co" -l optimizer-runs -d 'The number of runs specifies roughly how often each opcode of the deployed code will be executed across the life-time of the contract. This means it is a trade-off parameter between code size (deploy cost) and code execution cost (cost after deployment). An `optimizer_runs` parameter of `1` will produce short but expensive code. In contrast, a larger `optimizer_runs` parameter will produce longer but more gas efficient code' -r
...
complete -c forge -n "__fish_forge_using_subcommand se; and __fish_seen_subcommand_from co" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand se; and __fish_seen_subcommand_from upload" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand se; and __fish_seen_subcommand_from up" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand se; and __fish_seen_subcommand_from list" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand se; and __fish_seen_subcommand_from ls" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand se; and __fish_seen_subcommand_from find" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand se; and __fish_seen_subcommand_from f" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand se; and __fish_seen_subcommand_from cache" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand se; and __fish_seen_subcommand_from c" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand generate; and not __fish_seen_subcommand_from test help" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand generate; and __fish_seen_subcommand_from test" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand compiler; and not __fish_seen_subcommand_from resolve r help" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand compiler; and __fish_seen_subcommand_from resolve" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand compiler; and __fish_seen_subcommand_from r" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand soldeer; and not __fish_seen_subcommand_from init install update login push uninstall version help" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand soldeer; and __fish_seen_subcommand_from init" -l config-location -d 'Specify the config location' -r -f -a "{foundry\t'Store config inside the `foundry.toml` file',soldeer\t'Store config inside the `soldeer.toml` file'}"
complete -c forge -n "__fish_forge_using_subcommand soldeer; and __fish_seen_subcommand_from init" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand soldeer; and __fish_seen_subcommand_from install" -l config-location -d 'Specify the config location without prompting' -r -f -a "{foundry\t'Store config inside the `foundry.toml` file',soldeer\t'Store config inside the `soldeer.toml` file'}"
complete -c forge -n "__fish_forge_using_subcommand soldeer; and __fish_seen_subcommand_from install" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand soldeer; and __fish_seen_subcommand_from update" -l config-location -d 'Specify the config location without prompting' -r -f -a "{foundry\t'Store config inside the `foundry.toml` file',soldeer\t'Store config inside the `soldeer.toml` file'}"
complete -c forge -n "__fish_forge_using_subcommand soldeer; and __fish_seen_subcommand_from update" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand soldeer; and __fish_seen_subcommand_from login" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand soldeer; and __fish_seen_subcommand_from push" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand soldeer; and __fish_seen_subcommand_from uninstall" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand soldeer; and __fish_seen_subcommand_from version" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand eip712" -l optimize -d 'Activate the Solidity optimizer' -r -f -a "{true\t'',false\t''}"
...
complete -c forge -n "__fish_forge_using_subcommand eip712" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
...
complete -c forge -n "__fish_forge_using_subcommand bind-json" -l optimize -d 'Activate the Solidity optimizer' -r -f -a "{true\t'',false\t''}"
...
complete -c forge -n "__fish_forge_using_subcommand bind-json" -l color -d 'The color of the log messages' -r -f -a "{auto\t'Intelligently guess whether to use color output (default)',always\t'Force color output',never\t'Force disable color output'}"
